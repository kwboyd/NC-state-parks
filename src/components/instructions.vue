<template>
  <div id="intro">
    ...
    <p id="instructions"> <span class="color-text">To begin,</span> enter where you'd like to start your trip and where you'd like to end it. Then, <span class="color-text">click on the markers on the map</span> to pull up information about each park.
